...
// >hits.jf; >RESULT_DATA.csv; >RESULT_SCHEME.csv; gdb ../../build/benchmark_tests/clickbench/clickbench
// >hits.jf; >RESULT_DATA.csv; >RESULT_SCHEME.csv; sudo perf record -g ../../build/benchmark_tests/clickbench/clickbench
